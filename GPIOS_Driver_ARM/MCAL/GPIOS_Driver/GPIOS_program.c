...
u8 GPIOS_VoidSetPinDir(u8 Copy_u8PORT, u8 Copy_u8PIN,u8 Copy_u8Mode)
{
	u8 Local_u8ErrorStatus=RT_OK;

	if(Copy_u8PORT<0 ||Copy_u8PORT>2||Copy_u8PIN<0 ||Copy_u8PIN>15)
	{
...
u8 GPIOS_VoidGetPinVal(u8 Copy_u8PORT,u8 Copy_u8PIN ,u8 *Copy_U8ptrPinVal)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidSetPinVal(u8 Copy_u8PORT,u8 Copy_u8PIN, u8 Copy_u8PinVal)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidClearPin(u8 Copy_u8PORT,u8 Copy_u8PIN)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidClearPort(u8 Copy_u8PORT)
{
	u8 Local_u8ErrorStatus=RT_OK;


		if(Copy_u8PORT<0 ||Copy_u8PORT>2)
		{
			Local_u8ErrorStatus=RT_NOK;
...
u8 GPIOS_VoidSetPin(u8 Copy_u8PORT,u8 Copy_u8PIN)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidSetPort(u8 Copy_u8PORT)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidLockPort(u8 Copy_u8PORT)
{
	u8 Local_u8ErrorStatus=RT_OK;
...
u8 GPIOS_VoidLockPin(u8 Copy_u8PORT,u8 Copy_u8PIN )
{
	u8 Local_u8ErrorStatus=RT_OK;
