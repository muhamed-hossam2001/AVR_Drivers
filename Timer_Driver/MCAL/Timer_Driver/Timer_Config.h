...
/*TCCR2ِ_REG timer/Counter Control Register */
 ...
 *
 */
#define	TIMER2_OP_MODE  TIMER2_MODE_PWM_F
 ...
 *
 *
 *      TIMER2_OC2_PWM_F_CLR_COMP_SET_TOP
 *      TIMER2_OC2_PWM_F_SET_COMP_CLR_TOP
 *
 *
 *   Compare Output Mode, Phase Correct and Phase and Frequency Correct PWM
 *
 *
 *     TIMER2_OC2_PWM_PC_CLR_UPCOUNTING_SET_DOWNCOUNTING
 *     TIMER2_OC2_PWM_PC_SET_UPCOUNTING_CLR_DOWNCOUNTING
*/


#define TIMER2_OUTPUT_MODE     TIMER2_OC2_PWM_F_CLR_COMP_SET_TOP

/*Clock Selection*/
/*Options:
 *      TIMER2_CLK_SELCT_MASK
 *      TIMER2_NO_CLK
 ...
 *      TIMER2_EXT_CLK_FALLING_EDGE
 *      TIMER2_EXT_CLK_FALLING_RISING
 */

#define TIMER2_CLK_SEL  TIMER2_PRESCALER_DIV_8


/*Timer/Counter2 Interrupt Mask Register – TIMSK0*/
