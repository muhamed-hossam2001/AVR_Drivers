...
#define WAVEFORM_TIMER2_MODE_MASK      0b10110111
...
#define TIMER2_CTC_OUTPUT_MODES_MASK      0b11001111
...
#define TIMER2_OC2_PWM_F_CLR_COMP_SET_TOP                     (u8)0x20
#define TIMER2_OC2_PWM_F_SET_COMP_CLR_TOP                     (u8)0x30

/*
 * Compare Output Mode, Phase Correct and Phase and Frequency Correct PWM
 */

#define TIMER2_OC2_PWM_PC_CLR_UPCOUNTING_SET_DOWNCOUNTING     (u8)0x20
#define TIMER2_OC2_PWM_PC_SET_UPCOUNTING_CLR_DOWNCOUNTING     (u8)0x30
...
#define TIMER2_CLK_SELCT_SHIFT				 0
#define TIMER2_NO_CLK                        (u8)0x00
#define TIMER2_PRESCALER_DIV_1               (u8)0x01
#define TIMER2_PRESCALER_DIV_8               (u8)0x02
#define TIMER2_PRESCALER_DIV_64              (u8)0x03
#define TIMER2_PRESCALER_DIV_256             (u8)0x04
#define TIMER2_PRESCALER_DIV_1024            (u8)0x05
#define TIMER2_EXT_CLK_FALLING_EDGE          (u8)0x06
#define TIMER2_EXT_CLK_FALLING_RISING        (u8)0x07
...
void ss();
extern void TMR2_VoidClkSelection(u8 Copy_u8ClkSelectVal);

extern void TMR2_VoidStartTimer();

extern void TMR2_VoidStopTimer();

/*function to set PreLoad Value
 *Input:Preload Value
 *Output :return Error Status
 */
extern void TMR2_VoidSetPreLoadValue(u8 Copy_u8PreLoadVal);

extern void TMR2_VoidSetCTCValue(u8 Copy_u8CTCVal);

extern void TMR2_VoidEnableINT_OVF();

extern void TMR2_VoidDisableINT_OVF();

extern void TMR2_VoidEnableINT_CTC();

extern void TMR2_VoidDisableINT_CTC();
...
extern void TMR2_VoidInit_Prebuild(void);
